...
EllipsoidArrayDisplay::EllipsoidArrayDisplay() {
  color_property_ = new rviz_common::properties::ColorProperty(
      "Color", QColor(204, 51, 204), "Color of ellipsoids.", this,
...
void EllipsoidArrayDisplay::onInitialize() { MFDClass::onInitialize(); }
...
PLUGINLIB_EXPORT_CLASS(decomp_rviz_plugins::EllipsoidArrayDisplay,
                       rviz_common::Display)
